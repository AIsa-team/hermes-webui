...
function _beginSettingsPanelSession() {
  ...
  _settingsThemeOnOpen = localStorage.getItem('hermes-theme') || 'system';
  _settingsSkinOnOpen = localStorage.getItem('hermes-skin') || 'charizard';
...
function _appearancePayloadFromUi(){
  ...
  return {
    theme: ($('settingsTheme')||{}).value || localStorage.getItem('hermes-theme') || 'system',
    skin: ($('settingsSkin')||{}).value || localStorage.getItem('hermes-skin') || 'charizard',
...
function _rememberAppearanceSaved(payload){
  if(!payload) return;
  _settingsThemeOnOpen=payload.theme||localStorage.getItem('hermes-theme')||'system';
  _settingsSkinOnOpen=payload.skin||localStorage.getItem('hermes-skin')||'charizard';
...
async function loadSettingsPanel(){
  try{
    ...
    const skinVal=(localStorage.getItem('hermes-skin')||settings.skin||'charizard').toLowerCase();
