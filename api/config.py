...
_SETTINGS_DEFAULTS = {
    ...
    "skin": "charizard",  # accent color skin: default | ares | mono | graphite | slate | poseidon | sisyphus | charizard | sienna | catppuccin | nous
    ...
    "hide_composer_mic": True,  # hide dictation mic button in composer footer
...
def _normalize_appearance(theme, skin) -> tuple[str, str]:
    ...
    if legacy:
        ...
        next_theme, legacy_skin = raw_theme, "charizard"
    else:
        # Unknown themes used to exist; fall back to the shipped defaults.
        next_theme, legacy_skin = "system", "charizard"
    next_skin = (
        raw_skin
